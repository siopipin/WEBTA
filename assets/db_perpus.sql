...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 13, 2019 at 04:21 PM
...
(14, 'Lecture Notes_pertemuan 6(1).pdf', 23, 'HOGICPIVJMESAFJTKEZBIKRLDJMBSZZS', '29036', '29036_Lecture Notes_pertemuan 6(1).pdf.encrypted', 'Lecture Notes_pertemuan 6(1).pdf', '2019-02-07 10:59:44'),
...
(55, 'freud-leonardo-da-vinci.epub', 66, 'YHJNMMMWZCIPWVZGHPOTPPBVXYUBXALI', '50192', '50192_freud-leonardo-da-vinci.epub.encrypted', 'freud-leonardo-da-vinci.epub', '2019-02-08 13:56:55'),
(56, 'freud-totem-and-taboo.epub', 67, 'OLOVVAUKNZCXELDDPKYUZXJWDYCFOFYS', '2384', '2384_freud-totem-and-taboo.epub.encrypted', 'freud-totem-and-taboo.epub', '2019-02-08 14:04:24'),
...
(74, 'plaintextAES.txt', 20, 'BUBRRJFDSEZJZDYBWTHMDAMIFJSUWTOQ', '7465', '7465_plaintextAES.txt.encrypted', '', '2019-02-13 14:42:57'),
(75, 'plaintextAES.txt', 9, 'YXXSXJADLFJGTHXONZCEZBYSXYVGLLUK', '18614', '18614_plaintextAES.txt.encrypted', '', '2019-02-13 15:11:28'),
(72, 'buku 1.epub', 10, 'OFCKSOMLWSQCMTVGOHTGNJPYIPDQNCOF', '1961', '1961_buku 1.epub.encrypted', '', '2019-02-12 09:30:45');
...
(19, 3, 'ardi', NULL, NULL, NULL, NULL, 'ardi', 'ardi@mail.com', 'b623a7cebe5be1abc1409e528f6b4451', NULL, NULL, NULL, 1, 3, '2019-01-17 06:07:54', '2019-01-17 06:07:54', 0),
(13, 3, 'Pipin', NULL, NULL, NULL, NULL, 'pipin', 'pipin@mail.com', '3a1ed9acd58baf9eacdecea6310279ad', NULL, NULL, NULL, 1, 1, '2019-01-17 00:52:23', '2019-01-17 00:52:23', 0),
(16, 3, 'albert', 'Laki-laki', '', '0000-00-00', '', 'albert', 'albert@mail.com', '73503e6f479c632ebfebc6e58a3cd335', '', 'albert.png', NULL, 1, 1, '2019-01-17 03:33:57', '2019-01-17 03:33:57', 0),
(15, 3, 'Heru Kurniawan', 'Laki-laki', 'Dekat Pakam', '0000-00-00', 'Jl. Dekat Pakam No. 109', 'heru', 'heru@mail.com', '54ca719ab0dd44a736a6d9c298543199', '082246781686', 'heru.png', '15.png', 1, 1, '2019-01-17 03:00:25', '2019-01-17 03:00:25', 0),
(18, 3, 'citra', 'Laki-laki', '', '0000-00-00', '', 'citra', 'citra@mail.com', 'a471cc23d89f15b4c552246412714ee8', '', 'citra.png', NULL, 1, 1, '2019-01-17 05:30:48', '2019-01-17 05:30:48', 0),
(20, 3, 'prima', NULL, NULL, NULL, NULL, 'prima', 'prima@mail.com', 'ae412c64bb1161979d879424c800093f', NULL, NULL, '20.jpg', 0, 1, '2019-01-20 08:06:15', '2019-01-20 08:06:15', 0),
...
CREATE TABLE IF NOT EXISTS `tbl_pesan` (
  ...
  `pe_nama` varchar(50) DEFAULT NULL,
  `pe_email` varchar(70) DEFAULT NULL,
  `pe_judul` varchar(200) DEFAULT NULL,
  `pe_isi` varchar(500) DEFAULT NULL,
  `pe_status` int(11) DEFAULT '0',
  `pe_tanggal` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`pe_id`)
...
INSERT INTO `tbl_pesan` (`pe_id`, `pe_nama`, `pe_email`, `pe_judul`, `pe_isi`, `pe_status`, `pe_tanggal`) VALUES
(1, 'Sio', 'sio@email.com', 'Request Buku Pemograman Codeigniter ', 'Hallo, saya sio. saya ingin request buku pemograman codeigniter untuk bahan pembelajaran saya, terimakasih', 1, '2019-02-12 19:18:38'),
(2, 'Heru', 'heru@mail.com', 'Request Buku Ionic versi 3', 'Adakah epub ionic versi terbaru? saya ingin sekali membaca buku tutorial cara membuat aplikasi mobile dengan ionic', 0, '2019-02-12 19:19:30'),
(3, 'Albert', 'albert@mail.com', 'Saya ingin mendaftar', 'Websitenya bagus, saya ingin mendaftar. Terimakasih.', 0, '2019-02-12 19:19:43'),
(5, 'Pipin', 'pipin@mail.com', 'Pesan buku pemograman', 'Tolong buku pemogramannya di perbanyak dong, saya ingin belajar tentang pemograman', 0, '2019-02-12 19:20:57');
...
CREATE TABLE IF NOT EXISTS `tbl_rating` (
  ...
  `r_ulasan` varchar(500) DEFAULT NULL,
...
(1, 19, 8, 3, NULL, '2019-01-31 19:51:32'),
(2, 19, 19, 4, NULL, '2019-01-31 19:51:32'),
(3, 19, 9, 7, NULL, '2019-01-31 19:51:32'),
(4, 19, 10, 2, NULL, '2019-01-31 19:51:32'),
(5, 13, 8, 7, NULL, '2019-01-31 19:51:32'),
(6, 13, 19, 5, NULL, '2019-01-31 19:51:32'),
(7, 13, 10, 7, NULL, '2019-01-31 19:51:32'),
(8, 13, 21, 8, NULL, '2019-01-31 19:51:32'),
(9, 16, 8, 7, NULL, '2019-01-31 19:51:32'),
(10, 16, 9, 3, NULL, '2019-01-31 19:51:32'),
(11, 16, 10, 7, NULL, '2019-01-31 19:51:32'),
(12, 16, 22, 8, NULL, '2019-01-31 19:51:32'),
(13, 16, 25, 4, NULL, '2019-01-31 19:51:32'),
(14, 15, 21, 5, NULL, '2019-01-31 19:51:32'),
(16, 15, 23, 8, NULL, '2019-01-31 19:51:32'),
(17, 15, 24, 9, NULL, '2019-01-31 19:51:32'),
(18, 15, 66, 9, NULL, '2019-01-31 19:51:32'),
(19, 20, 8, 6, NULL, '2019-01-31 19:51:32'),
(20, 20, 9, 5, NULL, '2019-01-31 19:51:32'),
(21, 20, 10, 6, NULL, '2019-01-31 19:51:32'),
(22, 20, 22, 8, NULL, '2019-01-31 19:51:32'),
(23, 20, 23, 7, NULL, '2019-01-31 19:51:32'),
(34, 15, 9, 8, NULL, '2019-02-04 00:18:07'),
(41, 15, 18, 8, NULL, '2019-02-04 00:56:07'),
(42, 15, 8, 5, NULL, '2019-02-05 12:51:59'),
(43, 15, 10, 3, NULL, '2019-02-07 10:38:45'),
(44, 13, 72, 8, 'The Man ho as Thursday buku yang bagus, buku ini bercerita tentang pria yang penuh tanggung jawab terhadap nusa dan bangsa. Sangat rekomendasi buat kamu yang cinta tanah air.', '2019-02-12 10:15:09'),
(45, 16, 73, 9, 'Saya sangat menyukai buku A Romance of two worlds. Buku ini bercerita tentang kisa cinta antara tentara yang berbeda negara pada masa perang dunia pertama.', '2019-02-12 10:17:12'),
(46, 15, 69, 8, 'Ben-Hur bercerta tentang pria yang bernama Ben dan tinggal di rumah kumuh, cerita yang sangat inspiratif ketika ia berjuang mempertahankan hidup di antara perselisihan negara. Sangat rekomendasi', '2019-02-12 10:19:29'),
(47, 18, 70, 7, 'Sangat menakjupkan, Quo Vadis sangat inovatif untuk kamu yang suka membaca sejara perjuangan bangsa dalam mengatasi kemiskinan dan korupsi.', '2019-02-12 10:42:30');
...
(50, '15', '10', '2019-02-07 16:23:53', '2019-02-11 13:26:33', 'N'),
(51, '15', '23', '2019-02-07 19:36:05', '2019-02-11 13:25:07', 'N'),
(52, '15', '26', '2019-02-07 19:48:48', '2019-02-11 13:24:58', 'N'),
(53, '15', '24', '2019-02-07 19:50:49', '2019-02-08 22:49:02', 'N'),
(54, '15', '66', '2019-02-09 05:49:21', '2019-02-15 22:49:21', 'N'),
(55, '15', '66', '2019-02-11 20:24:27', '2019-02-11 13:24:39', 'N'),
(56, '15', '74', '2019-02-11 20:26:41', '2019-02-11 13:27:02', 'N'),
(57, '15', '74', '2019-02-11 20:27:22', '2019-02-11 13:37:05', 'N'),
(58, '15', '71', '2019-02-11 20:37:15', '2019-02-11 13:37:59', 'N'),
(59, '15', '67', '2019-02-11 20:38:38', '2019-02-18 13:38:37', 'Y'),
(60, '15', '70', '2019-02-13 10:19:03', '2019-02-20 03:19:03', 'Y'),
(61, '15', '72', '2019-02-13 10:19:17', '2019-02-20 03:19:17', 'Y'),
(62, '15', '65', '2019-02-13 10:19:31', '2019-02-20 03:19:31', 'Y');
COMMIT;
