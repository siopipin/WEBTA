...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwal: function(type){
        ...
        }else if(type == 'konfirmasi-hapus'){
            swal({
                    title: 'Yakin ingin menghapus?',
                    text: "Buku akan dihapus dari sistem!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonClass: 'btn btn-success',
                    cancelButtonClass: 'btn btn-danger',
    	...
    	}else if(type == 'second-clasification'){
            swal({
                title: 'Silahkan pilih klasifikasi lebih spesifik !',
                text: "",
                type: 'question',
                ...
                buttonsStyling: true
                    ...
                    var klasifikasi2 = document.getElementById("dklasifikasi2");
                    klasifikasi2.style.visibility = 'visible';
                }, function(dismiss) {
                  // dismiss can be 'overlay', 'cancel', 'close', 'esc', 'timer'
                  if (dismiss === 'cancel') {
                    var klasifikasi2 = document.getElementById("dklasifikasi2");
                    klasifikasi2.style.visibility = 'hidden';
                  }
                  var klasifikasi2 = document.getElementById("dklasifikasi2");
                    klasifikasi2.style.visibility = 'visible';
                });
